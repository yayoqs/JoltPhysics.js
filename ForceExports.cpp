...
void KeepAlive_AllFunctions() {
    ...
    volatile auto cv9 = &JPH::CharacterVirtual::GetCenterOfMassTransform;
    ...
    // NarrowPhaseQuery
    volatile auto npq0 = &JPH::NarrowPhaseQuery::CastRay;
    ...
    volatile auto r1 = &JPH::Ragdoll::RemoveFromPhysicsSystem;
    volatile auto r2 = &JPH::Ragdoll::Activate;
    ...
    (void)cv8; (void)cv9; (void)cv10; (void)cv11; (void)cv12;
    (void)npq0; (void)npq1; (void)npq2; (void)npq3; (void)npq4; (void)npq5;
